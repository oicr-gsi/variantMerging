...
## [2.5.6] - 2026-09-11
### Added
- overhead parameters to gatk and picard tasks for better Java Heap RAM allocation
### Changed
- [GRD-1178](https://jira.oicr.on.ca/browse/GRD-1178) Moved reference dictionary update code to preprocessing task

## [2.5.5] - 2026-08-26
### Added
- [GRD-1178](https://jira.oicr.on.ca/browse/GRD-1178) Added reference dictionary option for mergeVcfs task
